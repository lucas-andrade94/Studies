...
class EmailVerificacao extends Email {
    constructor(usuario, endereco) {
        super();
        this.from = '"Blog do Código" <noreply@blogdocódigo.com.br>';
...
class EmailRedefinicaoSenha extends Email {
    constructor(usuario, token) {
        ...
        this.html = `<h1>Olá!</h1><p>Você pediu para redefinir sua senha. Use o Token a seguir para trocar a sua senha: ${token}</p>`;
    }
}
