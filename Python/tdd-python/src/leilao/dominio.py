...
class Usuario:
    ...
    def propoe_lance(self, leilao, valor):
        if not self._valor_eh_valido(valor):
            raise LanceInvalido("Não pode propor um lance com valor maior do que o valor da carteira!!")
...
class Leilao:
    ...
    def _valor_maior_que_lance_anterior(self, lance):
        if lance.valor > self.__lances[-1].valor:
            ...
            raise LanceInvalido("O valor do lance deve ser maior do que o anterior!!")
